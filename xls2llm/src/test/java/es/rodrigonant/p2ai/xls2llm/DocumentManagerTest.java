...
import es.rodrigonant.p2ai.xls2llm.model.Category.V1alt;
import es.rodrigonant.p2ai.xls2llm.model.Category.V1_1alt;
...
//		cat1.setCategoryId(1);
		...
		cat1.setEvaluation(V1alt._00_CONTRA_CRITICA_ATAQUE);
...
//		cat2.setCategoryId(2);
		...
		cat2.setEvaluation(V1_1alt._02_ECONOMICO_OU_RECURSOS_MATERIAIS);
...
//		cat2.setCatDescription("Favorável/defesa do Nordeste");
		...
		System.out.println("cat1 eval code: " + cat1.getEvaluation().name());
//		System.out.println("cat1 eval description: " + cat1.getEvaluation().getDescription());
		System.out.println("cat2 eval code: " + cat2.getEvaluation().name());
